...
# All G-arms sit on the K2 base (no --override-kv): the SWA override is what broke
# long-context grounding (.3). These are the remaining sampler x template cells.
# label | server args | harness args | extra container env | fallback extra args
ARMS=(
  "G1_k2_coding|$CORE;$KV;$TPL;--chat-template-kwargs;$KW_PROD;$THINK;$MTP;--temp;0.6;--top-p;0.8;--top-k;20;--min-p;0;--repeat-penalty;1.0|--depths 2000,20000,50000,80000 --greedy-tools||"
  "G2_k2_hardtpl|$CORE;$KV;--jinja;--chat-template-file;/app/hardened.jinja;--chat-template-kwargs;$KW_PROD;$THINK;$MTP;$SAMP|--depths 2000,20000,50000,80000 --greedy-tools||"
  "G3_k2_hard_coding|$CORE;$KV;--jinja;--chat-template-file;/app/hardened.jinja;--chat-template-kwargs;$KW_PROD;$THINK;$MTP;--temp;0.6;--top-p;0.8;--top-k;20;--min-p;0;--repeat-penalty;1.0|--depths 2000,20000,50000,80000 --greedy-tools||"
  "G4_k2_nopreserve|$CORE;$KV;$TPL;--chat-template-kwargs;$KW_NOPRES;$THINK;$MTP;$SAMP|--depths 2000,20000,50000,80000 --greedy-tools||"
)
